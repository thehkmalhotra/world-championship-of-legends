                    ...
                    if (paymentStatus == false) {
                        const interval = setInterval(() => {
                            if (typeof smartech !== "undefined") {
                                ...
                                smartech('dispatch', 'payment_failure', {
                        ...
                        await router.push(`/lwl/payment/success/${router.query.slug}`);
                    }
                } else {
                    ...
                    <div className="lwl-container">
                        <div className="lwl-header-container">
                            <div className="page-headers">
                                ...
                                <p>
                                    Sorry, your payment failed. Please retry on the registration page. Contact us at{' '}
                                    <span onClick={() => window.location.href = "mailto:support@wclcricket.com"}>
                                        support@wclcricket.com
                                    </span>.
                                </p>
                                <Link href="/lwl/register">
...
export default LWLPaymentFailure;
